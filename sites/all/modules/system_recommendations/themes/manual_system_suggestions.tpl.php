<div class="cmt-suggestion">
    ...
    foreach($suggestions as $item){
        $comment_wrapper_class = "comment comment-by-node-author comment-by-viewer ajax-comment-wrapper clearfix comment-wrapper-".$item['id'];
     ?>
     <a id="comment-".$item['id']></a>
     <?php
        $origin_url_base='';
        if($item['recommendation_type'] == 'manual') {
            ...
            <div class="right-box">
                <div class="right-box-text1">
                    ...
                    <div class="field field-name-field-suggestion-source field-type-link-field field-label-hidden">
                        <div class="field-items">
                            <div class="field-item odd">
                                <a rel="nofollow" class="form-group form-groupform-groupform-groupform-groupform-groupform-group buyButton" target="_blank" href="<?php print $redirect_url;?>" onClick="_gaq.push(['_trackEvent', 'Wish_detail_buy', 'Click', 'Buy_<?php print $item['origin_url_base'];?>']);">
                                <?php
									//$origin_url_base='';
                                    if($item['recommendation_type'] == 'manual') {
                    ...
                    <div class="like-button">
                        <?php if($item['recommendation_type'] == 'manual') {
                            //echo '<img src="'.base_path() . $theme_path.'/images/thanks-recived.jpg" alt="Thanks" id="'.$item['id'].'">'; (isset($item['score'])) ? print $item['score'] : '0';
                ...
                <div class="right-box-text2">
                      ...
                      <span class="tooltipsle">
                        <a href="<?php print $redirect_url;?>" rel="nofollow" class="buyButton" target="_blank" onClick="_gaq.push(['_trackEvent', 'Wish_detail_buy', 'Click', 'Buy_<?php print $origin_url_base;?>']);" >Shop</a>
