...
<ul class="related-articles jcarousel-skin-default">
<?php
   foreach($search_blogs as $blog){
    $node = node_load($blog);
?>
<li class="relevant-articles-inner">
    ...
    <div class="relevant-articles-rightsugg">
        <div class="relevant-articles-name">
            ...
            ?>
            <a href="<?php print render($node-> field_url_article['und'][0]['url']); ?>"><?php strlen($node->title) > 60 ? print substr($node->title,0,60)."..." : print $node->title;?></a>
        ...
        <div class="relevant-articles-description">
            <p><?php
            strlen($node->body['und'][0]['value']) > 100 ? print substr($node->body['und'][0]['value'], 0, 100)."..." : print $node->body['und'][0]['value'];?></p>
        </div>
